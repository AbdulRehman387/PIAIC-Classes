...
var savedAccountNum: number = 12;
var userAccountNum: number = 12;
var savedPin: number = 3807;
var userPin: number = 3807;
...
//SWITCH-CASE
var morning: boolean = time >= 5 && time < 12;
var afternoon: boolean = time >= 12 && time < 18;
var evening: boolean = time >= 18 && time < 24;
switch (true) {
    case morning:
        console.log("Good Morning");
        break;
...
//SWITCH-CASE
var primary: boolean = _class <= 5;
var elementary: boolean = _class <= 8;
var secondary: boolean = _class <= 10;
var higherSecondary: boolean = _class <= 12;
var university: boolean = _class > 12;
switch (true) {
    case primary:
        console.log("Primary");
        break;
